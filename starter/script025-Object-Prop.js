...
console.log(`Je m'appelle ${moi["nom"]} ${moi["prenom"]}, j'ai ${moi["age"]} ans, je suis ${moi["nationalite"]} et je suis ${moi["profession"]}`)
...
console.log(moi)
moi.age = 23;
moi.profession = 'Web Developper'
console.log(`Je m'appelle ${moi.nom} ${moi.prenom}, j'ai ${moi.age} ans, je suis un ${moi.profession} ${moi.nationalite} et je suis ${moi.etatcivil}`)
